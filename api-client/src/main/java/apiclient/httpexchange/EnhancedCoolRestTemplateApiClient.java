...
@Component
public class EnhancedCoolRestTemplateApiClient implements ApiClient {
    private final CoolApiInterface coolApiInterface;

    public EnhancedCoolRestTemplateApiClient(@Qualifier("enhancedApiClientRestTemplate") CoolApiInterface coolApiInterface) {
